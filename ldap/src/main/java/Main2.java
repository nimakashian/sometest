...
//            env.put(Context.SECURITY_CREDENTIALS, "Kashian@adp12345");
            ...
            env.put(Context.SECURITY_PRINCIPAL, "CN=AtiyeMessageCenter,OU=service-accounts,OU=BA24,DC=Ab,DC=net"); //we have 2 \\ because it's a escape char
            env.put(Context.SECURITY_CREDENTIALS, "Mf8a@xA1");
